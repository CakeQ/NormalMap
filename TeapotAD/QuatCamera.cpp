...
void QuatCamera::rotate(const float yaw, const float pitch)
{
	...
	*/
	...
	_orientation = glm::normalize(fromAxisAngle(WORLDX, pitch) * _orientation); //around local axis
	_orientation = glm::normalize(_orientation * fromAxisAngle(WORLDY, yaw)); //around world axis
	updateView();
}
...
void QuatCamera::roll(const float z)
{
	...
	*/
	...
	_orientation = glm::normalize(fromAxisAngle(WORLDZ, z) * _orientation); //around local axis
	updateView();
}
